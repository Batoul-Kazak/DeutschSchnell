...
export const scoreFeedback = [
  {
    ...
    message:
      "Your result indicates that the material in this test was quite challenging. This is a valuable starting point. We recommend reviewing foundational concepts and practicing regularly. Every expert was once a beginner keep going!",
  },
  {
    min: 31,
    max: 50,
    title: "Good Start",
    message:
      "You’ve grasped some key ideas, but there’s room to strengthen your understanding. With targeted practice and a bit more time, you’ll build greater confidence. Progress isn’t always linear—what matters is that you’re moving forward.",
  },
  {
    min: 51,
    max: 74,
    ...
    message:
      "A solid performance! You’ve demonstrated a good command of many topics, though a few areas could benefit from further review. Keep building on this foundation—you’re well on your way to mastery.",
  },
  {
    min: 75,
    max: 90,
    ...
    message:
      "Excellent work! Your understanding of the material is strong, and your accuracy reflects consistent effort. With just a little more refinement, you’ll be ready to tackle even more advanced challenges.",
  },
  {
    min: 91,
    max: 100,
    ...
    message:
      "Outstanding achievement! You’ve shown a thorough and confident command of the content. This level of performance reflects deep understanding and careful preparation. Congratulations—you’ve truly mastered this level!",
  },
];
