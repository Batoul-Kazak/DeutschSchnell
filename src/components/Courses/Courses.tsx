                            ...
                            <div className="p-5 px-0 bg-gray-300 rounded-3xl w-[20rem] hover:scale-105 transition-transform duration-500 hover:shadow-[0_4px_12px_rgba(0.8,0.8,0.8,0.6)] shadow-[0_4px_12px_rgba(0,0,0,0.4)]">
                                ...
                                <div className="flex flex-col flex-wrap gap-2 py-5 px-7">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p className="flex gap-2">{lesson.tags.map((tags: string) => <span className="p-3 py-2 text-xs font-bold text-white transition-all rounded-full cursor-pointer hover:scale-105 hover:bg-white hover:shadow-lg hover:text-indigo-600 bg-my-blue" key={tags}>{tags}</span>)}</p>
                                    </div>
                                </div>
                            </div>
                        </Link>
