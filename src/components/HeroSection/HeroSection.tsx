...
function HeroSection() {
    ...
    return (
        <div id="home" className="relative flex items-center justify-center min-h-screen w-full p-4 sm:p-8 lg:p-[5rem]">
            <div 
            ...
            <div className="relative w-full max-w-7xl h-[60vh] md:h-[700px] overflow-hidden rounded-3xl shadow-2xl z-10">
                <div className="flex h-full transition-transform duration-700 ease-in-out" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
                    {slides.map((currentSlide, index) => (
                        <div key={index} className="relative flex flex-col justify-between w-full h-full p-6 shrink-0 sm:p-10 md:p-20">
                            <div 
