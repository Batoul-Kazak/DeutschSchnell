...
const Button = React.forwardRef<HTMLButtonElement, CustomButtonProps>(
    (
        ...
        const variantClasses = {
            primary:
                'bg-dark-red border-indigo-700 text-white hover:bg-light-violet hover:border-indigo-800 active:bg-indigo-800 active:border-transparent focus:ring-indigo-500 focus:ring-offset-white dark:focus:ring-offset-gray-900',
            secondary:
