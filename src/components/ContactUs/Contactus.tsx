    ...
    return <div id="contactus" className="relative h-[40rem]">
        ...
        <div className="absolute top-[20rem] rounded-3xl translate-y-[-50%] left-[50%] h-[35rem] z-20 w-[45%] " style={{ ...imageStyles, backgroundImage: `url(${heroSectionBackground})` }}>
            <div className="flex flex-col w-full gap-10 p-[5rem] gap-15 place-content-center">
                <input type="text" placeholder="Your Name..." className="p-2 pl-6 text-white rounded-full bg-violet placeholder:text-white" />
                <input type="email" placeholder="Your Email" className="p-2 pl-6 text-white rounded-full bg-violet placeholder:text-white" />
                <textarea placeholder="Your Message..." className="p-2 pl-6 text-white rounded-xl h-[10rem] bg-violet placeholder:text-white"></textarea>
