    ...
    return (
        <div id='reading'>
            <div className="flex flex-col gap-10 py-20">
                <h2 className="text-4xl font-bold text-light-violet">Reading</h2>
                ...
                {currentLesson?.readingQuestions && (
                    <div className="flex flex-col gap-10 pt-10">
                        ...
                        <div className="flex justify-center">
                            <button className="px-6 py-3 font-bold text-white transition rounded-full bg-dark-red hover:bg-dark-green">
                                Check Answers
                            </button>
                        </div>
                    </div>
