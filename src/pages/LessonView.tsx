    ...
    return <div className="relative flex flex-col gap-20 p-10 pt-20 place-items-center">
        ...
        <div className="flex flex-col w-full gap-5">
            ...
            <div className="flex flex-wrap gap-3 p-5 place-content-center place-items-center">
                {filteredWords.length ? filteredWords.map(item => <div className="flex gap-5 px-2 py-1 text-white rounded-md shadow-lg bg-my-violet text-violetbg-my-violet ">
                    <span className="font-bold text-my-blue">{item.german}</span>
                    ...
                    <div key={idx} className="mb-10">
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full border border-gray-200">
                                <thead>
                                    <tr className="text-white bg-my-blue">
